...
public class JSONWrite 
{
	public static void main(String[] args) 
	{
		...
		lessons.add(createLesson("Pénzügytan", "hétfő", "10", "12", "Inf. 103", "Dr. Bozsik Sándor", "G3BGI"));
		lessons.add(createLesson("Web technológiák 1", "hétfő", "14", "16", "XXX. előadó", "Agárdi Anita", "G3BGI"));
		lessons.add(createLesson("Web technológiák 1", "hétfő", "16", "18", "Inf. 202", "Agárdi Anita", "G3BGI"));
		lessons.add(createLesson("Mesterséges intelligencia", "kedd", "10", "12", "XXXII. előadó", "Kunné Dr. Tamás Judit", "G3BGI"));
		lessons.add(createLesson("Adatkezelés XML-ben", "kedd", "12", "14", "XXXII. előadó", "Dr. Bednarik László", "G3BGI"));
		lessons.add(createLesson("Adatkezelés XML-ben", "szerda", "10", "12", "Inf. 101", "Dr. Bednarik László", "G3BGI"));
		lessons.add(createLesson("Integrált vállalati rendszerek", "szerda", "12", "14", "X. előadó", "Dr. Samad Dadvandipour", "G3BGI"));
		lessons.add(createLesson("Integrált vállalti rendszerek", "szerda", "14", "16", "Inf. 15", "Kulcsárné Dr. Forrai Mónika", "G3BGI"));
		lessons.add(createLesson("Mesterséges intelligencia", "csütörtök", "10", "12", "I. előadó", "Fazekas Levente", "G3BGI"));
		JSONObject root = new JSONObject();
		root.put("ora", lessons);
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("KLNSPG_orarend", root);
		
		fileWrite(jsonObject, "orarendIN3BLK.json");
	...
	private static void consoleWrite(JSONObject jsonObject) 
	{
		...
		JSONObject root = (JSONObject) jsonObject.get("IN3BLK_orarend");
