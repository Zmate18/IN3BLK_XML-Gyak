        ...
        try {
            ...
            for (int i = 0; i < hotelList.getLength(); i++) {
                ...
                if ("1".equals(h_kod)) {
                    ...
                    System.out.println(
                            "Értékelés: " + hotelElement.getElementsByTagName("Ertekeles").item(0).getTextContent());
                    break; // Kilépü a ciklusból, mert megtaláltuk az első illeszkedő hotelt
                }
            }

            // 2. Lekérdezés: kiírja azoknak az alkalmazottaknak a nevét, akiknek a bére
            // több, mint 300000Ft
            ...
            // 3. Lekérdezés: kiírja azoknak a Vevőknek az adatait akik a Royal Hotelben
            // foglaltak szobát
            // Hotel elemek lekérdezése
                ...
                if ("Royal Hotel".equals(hotelNev)) {
                    ...
                    for (int j = 0; j < vevoList.getLength(); j++) {
                        ...
                        if (vevoSzKod.equals(hotelKod)) {
                            System.out.println(
                                    "Név: " + vevoElement.getElementsByTagName("Nev").item(0).getTextContent());
                            System.out.println(
                                    "Telefon: " + vevoElement.getElementsByTagName("Telefon").item(0).getTextContent());
                            System.out.println(
                                    "Email: " + vevoElement.getElementsByTagName("Email").item(0).getTextContent());
                        }
                    }
                }
            }

            // 4. lekérdezés: kiírja Kiss Anna számlázási adatait, azaz a szálloda nevét, a
            // szoba emeletét, a foglalás kezdetét és végét, valamint a fizetendő összeget
                ...
                if ("Kiss Anna".equals(vevoName)) {
                    ...
                    for (int j = 0; j < hotelListSzamlazas.getLength(); j++) {
                        ...
                        if (hotelKod.equals(customerSzKod)) {
                            ...
                            System.out.println(
                                    "Hotel neve: " + hotelElement.getElementsByTagName("Nev").item(0).getTextContent());
                                ...
                                if (szobaSzKod.equals(hotelKod)) {
                                    ...
                                    for (int l = 0; l < foglalasList.getLength(); l++) {
                                        ...
                                        if (foglalasSzKod.equals(szobaSzKod)) {
                                            System.out.println("Foglalás kezdete: " + foglalasElement
                                                    .getElementsByTagName("Kezdet").item(0).getTextContent());
                                            System.out.println("Foglalás vége: " + foglalasElement
                                    ...
                                    for (int m = 0; m < szamlaList.getLength(); m++) {
                                        ...
                                        if (szamlaVKod.equals(customerSzKod)) {
                                            System.out.println("Fizetendő összeg: " + szamlaElement
                                                    .getElementsByTagName("Osszeg").item(0).getTextContent());
                                        }
                                    }
                                }
                            }
            ...
            // 5. lekérdezés: kiírja azoknak a vevőknek a nevét, akik bankkártyával
                ...
                if ("Bankkártya".equals(fizetesmod)) {
                    ...
                    for (int j = 0; j < vevokList.getLength(); j++) {
                        ...
                        if (vevoVKod.equals(vevoFizetesVKod)) {
                            System.out.println(
                                    "Vevő neve: " + vevoElement.getElementsByTagName("Nev").item(0).getTextContent());
